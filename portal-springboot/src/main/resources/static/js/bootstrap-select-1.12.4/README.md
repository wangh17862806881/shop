...
* [//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4js/bootstrap-select.min.js](//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4js/bootstrap-select.min.js)
* //cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4js/i18n/defaults-*.min.js (The translation files)
