...
//AccessKey ID           LTAI4FjUYbkATaMEwBjKBx6j
// Access Key Secret    iMkZ0iZRxOIY08yYUGQlnz5ohp70zR
...
@Test
    public  void aaa() {
      ...
      //  logger.info("Started");
        ...
        try {
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "www";
            ossClient.putObject(bucketName, fileKey, new File("D:\\1902B\\冒泡排序.gif"));
   ...
   /*         // 查看Bucket中的Object。详细请参看“SDK手册 > Java-SDK > 管理文件”。
    ...
    public void testAliyunOss(){
        ...
        OSSClient ossClient = new OSSClient(endpoint, accessKeyId, accessKeySecret);
        String fileKey = "aaaaaaaaaaaaaaaaaa";
        OSS i = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        ossClient.putObject(bucketName, fileKey, new File("D:\\1902B\\冒泡排序.gif"));
       // System.out.println("Object：" + fileKey + "存入OSS成功。");
